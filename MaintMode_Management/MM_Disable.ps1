...
function debug($message)
{
    ...
    add-content -path "C:\Windows\AVC\Logging\XD_MM_off_$env:COMPUTERNAME.log" -Value "$(Get-Date -Format yyyy-MM-dd--HH-mm-ss) $message" 
}
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        debug "Machine Data retrieved. Proceeding to set MM off..."

                        Set-BrokerPrivateDesktop -MachineName $MachineData.MachineName -InMaintenanceMode:$false -AdminAddress $XenDesktopController -ErrorAction SilentlyContinue
                        ...
                        if($true -eq $OperationCheck.InMaintenanceMode)
                        {
                            debug "Failed to set MM off. Proceeding to unload the Snapin..."
                        ...
                        {
                            debug "MM successfuly set off. Proceeding to unload the snapin..."
